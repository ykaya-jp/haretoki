  ...
  return (
    <MotionProvider>
      <div className="min-h-dvh bg-background pb-[calc(56px+env(safe-area-inset-bottom))]">
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-[max(0.5rem,env(safe-area-inset-top))] focus:left-[max(0.5rem,env(safe-area-inset-left))] focus:z-[100] focus:rounded-lg focus:bg-primary focus:px-4 focus:py-2 focus:text-primary-foreground"
        >
          メインコンテンツへスキップ
        </a>
        <OfflineBanner />
