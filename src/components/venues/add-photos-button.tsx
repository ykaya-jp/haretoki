  ...
  return (
    <>
      <button
        ...
        disabled={uploading}
        className="inline-flex items-center gap-1.5 rounded-full border border-border bg-card px-4 py-2 text-xs text-muted-foreground transition-all duration-[400ms] hover:text-foreground hover:border-foreground/30 active:scale-95 disabled:opacity-50"
      >
        {uploading ? (
