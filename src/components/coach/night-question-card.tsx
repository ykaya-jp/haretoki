...
export function NightQuestionCard({ question }: { question: NightQuestion }) {
  ...
  return (
    <Link
      href={href}
      className="group block rounded-2xl border p-5 transition active:scale-[0.99]"
      style={{
        background:
    ...
    >
      ...
      <p className="mt-3 font-[family-name:var(--font-display)] text-[17px] font-light leading-[1.55] tracking-[0.005em] text-foreground">
        {question.text}
      </p>
