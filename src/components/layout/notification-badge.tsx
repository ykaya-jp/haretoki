  ...
  return (
    ...
    >
      ...
      {count > 0 && (
        <span
          aria-hidden="true"
          className="absolute right-1.5 top-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-[var(--destructive)] text-[10px] font-medium text-primary-foreground tabular-nums"
        >
          {count > 9 ? "9+" : count}
        </span>
      )}
