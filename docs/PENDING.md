...
- ✅ **ADR 導入** (2026-05-02 P2.E): `docs/harness/adr/` README + 0001-0005 retroactive + 0006 (drift hook) 起票
- ✅ **MCP 運用 doc** (2026-05-02 P2.E): `feat/p2-mcp-doc-paneC` `docs/harness/mcp.md` + `.mcp.json.example` canonical
- 🟡 View Transitions API (Tier 3 X-9) — UI 体験向上、必須ではない、worker C2 が並走候補
...
| ID | タスク | 規模 | 着手判断 |
|---|---|---|---|
| W18-2 | Partner Level 2 (6 次元星評価) | 中 | パートナー機能 (B section) と同時着手 |
| W18-3a | deleteVenue dual-confirmation | 小 | Partner Level 2 完了後 |
| W20-2 | 見学当日のクイックキャプチャ (写真+GPS+timestamp) | 中 | 商用化前に実施 (UX クリティカル) |
| W20-5 | 見学メモ orphan 画像クリーンアップ routine | 小 | バックグラウンド cron として追加 |
| W21 残 | 触覚 / 細部仕上げ (W21-3 / W21-4 / W21-7 / W21-8 / W21-9) | 小 | UI worker (C 系) の隙間タスク |
