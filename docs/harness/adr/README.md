...
- [0007 View Transitions API は shared-element 名前体系のみ先行投入し、SPA flag は無効を維持する](./0007-view-transitions-scoped-prototype-not-spa-default.md)
- [0008 Phase 3 docs 自動化 (drift hook + curator + cron) は段階的 gating で投入する](./0008-phase-3-docs-automation-cron-gating.md)
- [0009 Resend webhook + Vercel BotID をフィーチャーフラグ可能な形で導入する](./0009-resend-webhook-and-vercel-botid.md)
